<footer class="p-4 bg-cream sm:p-6 dark:bg-zinc-900">
    <div class="sm:text-xs md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <a href="https://masjidfatimahmuhammad.com/" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">فاطمة محمد</span>
            </a>
        </div>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a
                href="https://masjidfatimahmuhammad.com/" class="hover:underline">Masjid Fatimah Muhammad</a>. All
            Rights Reserved.
        </span>
