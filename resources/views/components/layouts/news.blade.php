    ...
    <div class="flex flex-col md:flex-col lg:flex-row gap-3">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                @foreach ($posts->data as $post)
                    <div
                        ...
                        <div
                            class="p-5 text-center md:text-left lg:text-left flex flex-col justify-center md:justify-start lg:justify-start">
                            <p class="pb-2 dark:text-cream font-bold lg:text-lg md:text-md text-sm">{{ $post->title }}
                            </p>
                            <p
                                class="hidden md:h-36 lg:h-36 text-ellipsis overflow-hidden dark:text-cream md:flex lg:flex">
                                {{ $post->body }}</p>
                            <a href="/posts/{{ $post->slug }}"
                                class="lg:text-lg md:text-md text-sm justify-center md:justify-start lg:justify-start mt-5 inline-flex items-center font-medium text-center text-zinc-900 bg-transparent rounded-lg dark:text-cream">
                                Read more
                ...
                {{-- <div
                    ...
                    <div class="p-5">
                        <a href="#">
                            <h5
                                class="mb-2 md:text-left lg:text-left sm:text-center sm:text-xs text-xl md:text-lg lg:text-lg font-bold tracking-tight text-zinc-900 dark:text-cream">
                                Noteworthy
                    ...
                    <div class="inline-flex items-center">
                        ...
                        @else
                            <a href="{{ $posts->prev_page_url }}"
                                class="inline-flex justify-center sm:w-auto w-32 px-4 py-2 mr-3 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                <svg aria-hidden="true" class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M7.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l2.293 2.293a1 1 0 010 1.414z"
        ...
        <div class="hidden lg:flex md:hidden flex-col flex-1">
            <iframe class="rounded-lg items-center h-2/4 w-full"
                ...
                allowfullscreen></iframe>
            <!-- archive box -->
            <div class="w-full pt-3 h-64 filter-box">
