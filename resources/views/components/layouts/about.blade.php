<section id="tentang-kami" class="p-5 mx-auto">
    ...
    <div class="md:grid xl:grid grid-cols-1 2xl:grid-cols-1 gap-4 pt-5">
        <div class="col-span-2">
            <img class="shadow-md md:rounded lg:rounded" src="assets/image/masjid-2.jpg " alt="gambar-masjid">
        </div>
        <div class="mt-3 lg:mt-0 md:mt-0">
            <div
                class="flex flex-col shadow-md border border-cream rounded-lg dark:border-zinc-700 p-10 dark:text-white">
                <span class="dark:text-cream inline text-xl md:text-2xl lg:text-3xl"><strong>M</strong>asjid
